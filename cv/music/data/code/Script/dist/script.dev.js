...
Maed.addEventListener("touchstart", function (e) {
  ...
  if (window.innerWidth < 768) {
    ...
    var u = 0;
    var m = yae;
    music[m].addEventListener("touchstart", function (e) {
      var stX = e.changedTouches[0].clientX;

      if (u == 0) {
        music[m].addEventListener("touchend", function (t) {
...
plause[1].addEventListener("click", function () {
  if (x == 0) {
    audi[1].play();
...
plause[2].addEventListener("click", function () {
  if (x == 0) {
    audi[2].play();
...
plause[3].addEventListener("click", function () {
  if (x == 0) {
    audi[3].play();
...
plause[4].addEventListener("click", function () {
  if (x == 0) {
    audi[4].play();
