...
for (var w = 0; w < 4; w++) {
  document.querySelectorAll(".tops5,.nofifiue5,.room5,.xam5")[w].style.display = "none";
}
...
function clas5() {
  ...
  document.querySelector(".hovering").style.transform = "translateY(".concat(Fromtop, "px)");
}
...
function xam5() {
  if (window.innerWidth < 768) {
    ...
    document.querySelector(".xam5").style.display = "flex";
  }

  for (var w = 0; w < 4; w++) {
    document.querySelectorAll(".tops5,.nofifiue5,.room5,.clas5")[w].style.display = "none";
  }
...
function room5() {
  ...
  for (var w = 0; w < 4; w++) {
    document.querySelectorAll(".tops5,.nofifiue5,.xam5,.clas5")[w].style.display = "none";
  }
...
function nofifiue5() {
  ...
  for (var w = 0; w < 4; w++) {
    document.querySelectorAll(".tops5,.room5,.xam5,.clas5")[w].style.display = "none";
  }
...
function tops5() {
  ...
  for (var w = 0; w < 4; w++) {
    document.querySelectorAll(".nofifiue5,.room5,.xam5,.clas5")[w].style.display = "none";
  }
...
for (var X = 0; X < 5; X++) {
  var hoving = function hoving() {
    document.querySelector(".hovering").style.opacity = "1";
  };

  var hovings = function hovings() {
